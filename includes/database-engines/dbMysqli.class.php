<?php
// BLP 2014-01-10 -- add freeResult() and fetchrow('obj').
/**
 * Database Class
 *
...
class dbMysqli extends dbAbstract {
   ...
   * @param string|null, if null then $type='assoc'
   * @param bool|null, if null then false.
   *   if param1, param2=bool then $type='assoc' and $returnarray=param2
  ...
  public function fetchrow($result=null, $type="both") {
    ...
    switch($type) {
      ...
      case "num":  // numerical array
        ...
        break;
      case "obj":  // BLP 2014-01-10 -- Add fetchrow as an object
