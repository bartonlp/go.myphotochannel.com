...
$cpanelAr = 
$lastMod = lastMod(array("cpanel.*php", "cpanel.ajax.php", "!js/cpanel.admin.js", "js/cpanel.*.js"),
                   $cwd) . ", $cpanelVersion";
...
<!-- The 'base' must change when the cpanel-vn.nn changes!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
  <base href="http://go.myphotochannel.com/$cpanelVersion/cpanel/cpanel.php?siteId=$S->siteId">
<!-- ********************************************************************************** -->
...
var lastMod="$lastMod";
  ...
  <script src="js/cpanel.category.js$nocache"></script>
  <script src="js/cpanel.expunge.js$nocache"></script>
  <script src="js/cpanel.newuser.js$nocache"></script>
  <script src="js/cpanel.showsettings.js$nocache"></script>
  <script src="js/cpanel.managecontent.js$nocache"></script>
  <script src="js/cpanel.games.js$nocache"></script>
  <script src="js/cpanel.lotto.js$nocache"></script>
