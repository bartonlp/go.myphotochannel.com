...
if($_GET['cache'] == 'true') {
  $scriptfile = "js/slideshow.js";
} else {
  $nocache = "?nocache=".time();
  $scriptfile = "js/slideshow.js$nocache";
}
...
// If userId= on URL then set $this->id in SiteClass to userId
// If there is NO userId= then force the id to zero instead of getting the id from the cookie.
...
// The directories are now off the DOC_ROOT and are vN.NN/slideshow/slideshow.php
$cwd = getcwd();
