...
// JavaScript for '/var/www/tomsproject/cpanel-php/admindb.panel.php'

var version = " (May 15 v1.01)";
// The Main Ajax file

var ajaxfile = "adsCpanel.ajax.php";
...
function postItemsFrame(e, self) {
  ...
  var id, touch, status, dur, desc, trans, effect;
  ...
  // trans = table.find("input[name='trans']").val();
  // effect = table.find("input[name='effect']").val();
...
function refreshImages(e, limit, startId) {
  ...
  var status = $("#statusselect").find(":selected").text();
